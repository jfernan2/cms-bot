    ...
    "11834.21": {
        ...
        "steps": {
            ...
            "step4": {
                "TimeMemoryInfo": True,
                "FastTimer": True,
                "igprof": False,  #Performance Profile crashes on module DeepTauId/'deepTau2018v2p5ForMini'
            },
            "step5": {
                "TimeMemoryInfo": True,
                "FastTimer": True,
                "igprof": False,  #Memory profiler crsahes with Segmentation violation right after opening input file
            },
        },
        "nThreads": 1,
        "matrix": "upgrade",
